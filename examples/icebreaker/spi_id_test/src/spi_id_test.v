...
// connected to PMOD1B on the iCEBreaker FPGA board
// and Digilent pmod8LD connected to PMOD2 for LED output
// 
// FUNCTION: 
...
module spi_id_test #(
    ...
    parameter CLK_FREQ      = 12_000_000  // 12MHz System Clock
)(
